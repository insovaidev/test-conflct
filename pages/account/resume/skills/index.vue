            ...
            <div :class="isMobile ? 'p-3' : 'form_input p-3 bg-white mt_80'">
                ...
                <form role="form">
                    <div class="mb-3">
                        ...
                        <input type="text" v-model="formData.title" class="form-control more_border" :class="isMobile ? 'field-height' : 'dt-field-height'" id="title" name="title">
                    </div>
                    <div class="mb-3 botton-style">
                        ...
                        <select id="level" v-model="formData.level" class="form-control more_border" :class="isMobile ? 'field-height' : 'dt-field-height'" name="level">
...
function saveData(){
    ...
    if(auth_users.value){
        ...
        if(window.navigator.onLine){
            ...
            $fetch(config.VUE_APP_API_URL_JOB+'me/resume/skills', {
                method: "POST", 
                headers: { "Content-Type": "application/x-www-form-urlencoded", "Access-Token": auth_users.value.tokens.access_token },
